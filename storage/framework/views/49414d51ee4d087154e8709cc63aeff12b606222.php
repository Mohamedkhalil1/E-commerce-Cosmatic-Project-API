                      ...
                      <?php $__currentLoopData = $order->products()->orderBy('quantity','desc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php else: ?>
                            <tr>
                                ...
                                <td>
                                    <?php echo e($details->where('product_id',$product->id)->first()->price_discount * $details->where('product_id',$product->id)->first()->quantity); ?> EGP
                                </td>
                            </tr>
                          <?php endif; ?>
...
</div><?php /**PATH E:\360 cloud solution\OUTLET_PROJECT\Outlet - Copy - Copy\resources\views/pdf/invoice.blade.php ENDPATH**/ ?>