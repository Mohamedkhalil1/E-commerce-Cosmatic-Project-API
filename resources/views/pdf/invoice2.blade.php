                      ...
                      @foreach ($order->products as $index => $product)
                        ...
                        @else
                            <tr>
                                ...
                                <td>{{ $product->title }}</td>
                                <td>
                                    {{$details->where('product_id',$product->id)->first()->price.' EGP'}}
                                </td>
                                ...
                                <td>
                                    {{$details->where('product_id',$product->id)->first()->price_discond * $details->where('product_id',$product->id)->first()->quantity}} EGP
                                </td>
                            </tr>
                          @endif
                        @endforeach
